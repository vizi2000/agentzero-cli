...
# Import backend from parent directory
import sys
import webbrowser
...
_backend_spec = importlib.util.spec_from_file_location(
    "backend_module",
    os.path.join(_project_root, "backend.py"),
)
_backend_module = importlib.util.module_from_spec(_backend_spec)
_backend_spec.loader.exec_module(_backend_module)
MockAgentBackend = _backend_module.MockAgentBackend
RemoteAgentBackend = _backend_module.RemoteAgentBackend
